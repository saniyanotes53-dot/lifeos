...
import {
  Home, ListChecks, Moon, Wallet, BarChart3, Clock, User, LogOut, Sparkles, Sun, Settings, ChevronRight
} from "lucide-react";
...
export default function App() {
  ...
  const [tab, setTab] = useState("home"); // home, tasks, health, budget, timetable, reports, profile
  ...
  // 5 core nav items for mobile bottom bar + full sidebar items
  const NAV = [
    ["home", Home, "Home"],
    ...
    return (
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
          <div className="pulse" style={{ width: 44, height: 44, borderRadius: 14, background: `linear-gradient(135deg, ${t.a1}, ${t.a3})`, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Sparkles size={22} color={t.onAccent} />
          </div>
          <div style={{ fontSize: 13, fontWeight: 600 }}>Loading Life OS…</div>
        </div>
      </div>
    );
  }

  // Not logged in: Show Full-page Auth Screen with Buraq Studios copyright
  if (!user) {
    return (
      <div style={{
  ...
  // Logged In: Full Desktop / Tablet / Mobile Website Layout
  return (
    <div style={{
      ...
      <aside className="desktop-sidebar" style={{
        ...
        <div style={{ padding: "24px 22px 18px", display: "flex", alignItems: "center", gap: 12, borderBottom: `1px solid ${t.line}` }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: t.muted }}>Personal Productivity</div>
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100vh", overflow: "hidden" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, margin: 0, textTransform: "capitalize", color: t.text }}>
              {tab}
            </h2>
        ...
        {/* MOBILE BOTTOM NAVIGATION (5 primary items) */}
        <nav className="mobile-nav" style={{
          position: "fixed", bottom: 0, left: 0, right: 0,
          background: t.surface, borderTop: `1px solid ${t.line}`,
          padding: "8px 10px 14px", display: "none", justifyContent: "space-around",
